...
// Metadata will be handled by the default export function
...
function WelcomeContent() {
  ...
  const errorConfigs = {
    ...
    already_verified: {
      ...
      description: email
        ? `Great news! The email ${email} is already verified. You can proceed with your registration.`
        : 'This email is already verified. You can proceed with your registration.',
  ...
  const completedSteps = [
    {
      ...
      description: 'Your Ipemelere account has been successfully created',
      completed: true,
    },
    {
      icon: CheckIcon,
  ...
  const remainingSteps = [
    {
      ...
      description: 'Upload a clear photo of your national ID for verification in the Ipemelere app',
    ...
    },
    {
      ...
      description: 'Verify your phone number to receive ride updates in the Ipemelere app',
      action: 'Continue in App',
      href: '#download',
    },
  ];
            ...
            <div className="text-center">
              ...
              {isSuccess && (
                <>
                  ...
                  <p className="mt-8 text-xl sm:text-2xl text-gray-100 leading-relaxed max-w-4xl mx-auto">
                    {email ? `Welcome back, ${email}!` : 'Your account has been created successfully!'}
                    <span className="font-semibold text-yellow-300"> Complete a few more steps</span> to start booking
                    <span className="font-semibold text-lime-300"> safe and reliable rides</span> across Malawi.
              ...
              {!status && (
                <>
                  ...
                  <p className="mt-8 text-xl sm:text-2xl text-gray-100 leading-relaxed max-w-4xl mx-auto">
                    Your journey with safe and reliable transport starts here.
                    <span className="font-semibold text-yellow-300"> Complete your registration</span> to start booking
                    <span className="font-semibold text-lime-300"> rides across Malawi</span>.
                    <span className="block mt-4 text-lg italic font-medium text-yellow-200">
                      Ndife Aganyu Anu
                    </span>
                  </p>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        {(message === 'expired' || message === 'invalid' || message === 'not_found') && (
                          <div className="space-y-3">
                            <p className="text-sm text-orange-700 font-medium">
                              📱 To {currentError.actionText.toLowerCase()}, please use the Ipemelere mobile app or contact support.
                            </p>
                            <Button
                              size="lg"
                        ...
                        {message === 'already_verified' && (
                          <div className="space-y-3">
                            <p className="text-sm text-blue-700 font-medium">
                              📱 Continue your registration in the Ipemelere mobile app to complete setup and start booking rides.
                            </p>
                            <Button
                              size="lg"
            ...
            {(isSuccess || (!status)) && (
              <div className="text-center mb-20">
                ...
                <h2 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6">
                  Getting You
                  <span className="bg-gradient-to-r from-green-600 to-yellow-600 bg-clip-text text-transparent"> Ride Ready</span>
                </h2>
                <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                  Just a few more steps to complete your registration and start booking rides
                </p>
              </div>
            )}
                ...
                <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 border border-slate-100 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-600 leading-6">
                      All our drivers are thoroughly verified and trained for your safety and comfort.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-8">
              ...
              <p className="text-xl sm:text-2xl text-gray-100 leading-relaxed max-w-4xl mx-auto mb-12">
                Finish the setup process and you'll be ready to book your first ride with
                <span className="font-semibold text-yellow-300"> confidence</span> and
                <span className="font-semibold text-lime-300"> convenience</span>.
              </p>
            </div>

            <div className="text-center mb-8">
              <p className="text-lg text-white/90 mb-6">
                📱 Complete your registration in the Ipemelere mobile app to start booking rides!
              </p>
            ...
            <div className="text-center">
              <p className="text-lg text-white/90 mb-4">Questions? We're here to help 24/7:</p>
