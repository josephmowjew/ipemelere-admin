/**
 * Driver Document Reject Dialog - Modal for admin to reject driver documents with custom reason
 */
...
interface DriverDocumentRejectDialogProps {
...
export function DriverDocumentRejectDialog({
  document,
  isOpen,
  onClose,
  onReject,
  isRejecting = false
}: DriverDocumentRejectDialogProps) {
  const [reason, setReason] = useState('');
  const [notes, setNotes] = useState('');
  const [error, setError] = useState<string | null>(null);

  // Common rejection reasons for quick selection - driver-specific
  const commonReasons = [
    'Document image is unclear and text is not readable',
    'Document appears to be damaged or incomplete',
    'Document has expired',
    'License or registration information is invalid',
    'Document appears to be altered or fraudulent',
    'Photo quality is too poor to verify identity',
    'Document information does not match driver details',
    'Vehicle information does not match registration',
    'Insurance document is invalid or expired'
  ];
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {getDocumentDisplayName(document.documentType)} - {document.originalFileName}
                </p>
              </div>
            </div>
            <Button
          ...
          <div className="p-6 space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    The driver will be notified by email about this rejection and the reason provided.
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                This reason will be included in the email notification sent to the driver.
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                These notes are for internal use and will not be sent to the driver.
              </p>
            </div>
